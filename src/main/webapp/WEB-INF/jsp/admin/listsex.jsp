...
<style style="text/css">
	...
	.min{height:20px;width:20px;background:rgb(254, 169, 165);padding-left:0;}
	.famale{background:rgb(163, 200, 252);height:20px;width:20px;}
...
<body>
 <h1 style="text-align:center;padding-top:150px;">卖出商品和购买人性别统计图</h1>
 <div style="margin-top:100px;padding-left:100px;height:30px;">
	 
     
 </div>
  
 <div class="histogram-container" id="histogram-container" style="margin-top:50px;">
    <!--背景方格-->
    <div class="histogram-bg-line">
        ...
        <ul>
            ...
            <li><div></div></li>
            <li><div></div></li>
            <!-- <li><div><img src="img/zhu1.jpg" width="15" height="15" />&nbsp 男性</div></li> -->
        </ul>
        <ul>
            <li><div></div></li>
            <li><div></div></li>
    ...
    <div class="histogram-content">
        <ul>
            ...
            <li>
                <span class="histogram-box"><a style="height:${sexlist.num}0%;" title="20%" class="aOne"></a>${sexlist.sex } : ${sexlist.num}</span>
                <span class="name">${sexlist.name}</span>
